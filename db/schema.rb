...
ActiveRecord::Schema[7.0].define(version: 2022_09_02_175520) do
  ...
  create_table "group_budgets", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["budget_id"], name: "index_group_budgets_on_budget_id"
    t.index ["group_id"], name: "index_group_budgets_on_group_id"
  end
